...
#define SERVICE_UUID           "12345678-1234-1234-1234-123456789abg"
#define CHARACTERISTIC_UUID    "87651321-4321-4321-4321-cba967654325"

// Define the device name and clue text
#define DEVICE_NAME            "LVSH_Clue5"
#define CLUE_TEXT              "Feast if you dare, but watch your step! One wrong move, and you might end up in 'HIS' locker. Can you find where the sea’s secrets are stashed?"
