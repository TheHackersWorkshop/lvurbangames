...
#define SERVICE_UUID           "12345678-1234-1234-1234-123456789abw"
#define CHARACTERISTIC_UUID    "87651321-4321-4321-4321-cba967654343"

// Define the device name and clue text
#define DEVICE_NAME            "LVWT_Clue2"
#define CLUE_TEXT              "The one you seek is dressed in not the norm, yet for Las Vegas, it's not out of place."
