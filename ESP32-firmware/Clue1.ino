...
#define CHARACTERISTIC_UUID    "87651321-4321-4321-4321-cba967654321"

// Define the device name and clue text
#define DEVICE_NAME            "LVSH_Clue1"
#define CLUE_TEXT              "Track down the place with vintage flair and a whisker of charm - where fashion has nine lives!"
...
const long interval = 10000;  // Interval to restart advertising (10 seconds)
...
void loop() {
  ...
  // Restart advertising every 10 seconds (or the interval you've set)
